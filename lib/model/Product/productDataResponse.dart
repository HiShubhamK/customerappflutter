...
//   dynamic productSeoName;
//   dynamic customRatingMessage;
...
//     required this.productSeoCategory,
...
//     required this.isToSellingProduct,
//     required this.stockStatus,
//     required this.productRating,
//     required this.stockCount,
//     required this.createdOn,
//     required this.counter,
//     required this.stockCounterAmount,
//     required this.productSeoName,
//     required this.customRatingMessage,
...
class ProductDataResponse {
  ...
  ProductDataResponse({this.isSuccess, this.data, this.responseMessage});

  ProductDataResponse.fromJson(Map<String, dynamic> json) {
