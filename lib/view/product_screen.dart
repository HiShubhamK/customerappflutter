import 'package:customerappdart/data/response/status.dart';
import 'package:customerappdart/view_model/product_viewmodel.dart';
...
class _ProductScreen extends State<ProductScreen> {
  ...
  ProductViewViewModel productlistmodel =ProductViewViewModel();

  @override
  void initState() {
    // TODO: implement initState
    productlistmodel.getProductlist(context);
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        ChangeNotifierProvider<ProductViewViewModel>(
          create: (BuildContext context) => productlistmodel,
          child: Consumer<ProductViewViewModel>(
            builder: (context, values, child) {

              switch(values.productlistdata.status){
                case Status.LOADING:
              ...
              return Text(
                '${values.productlistdata.data!.data}',
